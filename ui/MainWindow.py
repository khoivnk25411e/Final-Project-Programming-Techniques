...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.checkinEventCombo.setStyleSheet("background-color: rgb(85, 170, 127);")
...
"color: rgb(0, 0, 0);")
        ...
        self.checkinCode.setPlaceholderText("")
...
"background-color: rgb(85, 170, 127);")
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Event Check-in Management"))
        self.titleLabel.setText(_translate("MainWindow", "EVENT CHECK-IN MANAGERMENT"))
        self.btnAddEvent.setText(_translate("MainWindow", "➕ New Event"))
        ...
        self.attendeeSearch.setPlaceholderText(_translate("MainWindow", "name, email, phone number, organisation, ..."))
        ...
        item.setText(_translate("MainWindow", "Organisation"))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.attendeeTab), _translate("MainWindow", "👥 Attendee"))
        self.label_2.setText(_translate("MainWindow", "Choose Event"))
        ...
        item.setText(_translate("MainWindow", "Regis Date"))
        item = self.registrationTable.horizontalHeaderItem(5)
        item.setText(_translate("MainWindow", "Status"))
        self.btnGenerateQR.setText(_translate("MainWindow", "📱QR"))
        self.btnCancelRegistration.setText(_translate("MainWindow", "❌ Delete "))
        ...
        self.label_3.setText(_translate("MainWindow", "Choose Event"))
        self.statsGroup.setTitle(_translate("MainWindow", "📊 "))
        ...
        self.totalCheckedinLabel.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" color:#ff0000;\">0</span></p></body></html>"))
        self.checkinGroup.setTitle(_translate("MainWindow", "✅ Check-in"))
        self.label_6.setText(_translate("MainWindow", "Code / QR:"))

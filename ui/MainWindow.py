...
"}")
        ...
        self.btnChangePassword.setStyleSheet(
            "QPushButton {"
        ...
        self.bodyLayout = QtWidgets.QHBoxLayout(self.contentWidget)
        self.bodyLayout.setContentsMargins(0, 0, 0, 0)
        self.bodyLayout.setSpacing(0)

        # ── Sidebar ───────────────────────────────────────────────────────
        self.sidebar = QtWidgets.QWidget(parent=self.contentWidget)
        ...
        self.sidebarTitle = QtWidgets.QLabel(parent=self.sidebar)
        self.sidebarTitle.setObjectName("sidebarTitle")
        self.sidebarTitle.setFixedHeight(48)
        self.sidebarTitle.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.sidebarLayout.addWidget(self.sidebarTitle)

        # Separator
        sep = QtWidgets.QFrame(self.sidebar)
        sep.setFrameShape(QtWidgets.QFrame.Shape.HLine)
        sep.setObjectName("sidebarSep")
        self.sidebarLayout.addWidget(sep)

        # Nav buttons
        def _nav_btn(text, obj_name):
            btn = QtWidgets.QPushButton(text, parent=self.sidebar)
        ...
        self.navDashboard    = _nav_btn("🏠  Dashboard",       "navDashboard")
        self.navEvents       = _nav_btn("📅  Events",          "navEvents")
        self.navAttendees    = _nav_btn("👥  Attendees",       "navAttendees")
        self.navRegistration = _nav_btn("📋  Registrations",   "navRegistration")
        self.navCheckin      = _nav_btn("✅  Check-in",        "navCheckin")
        self.navStaff        = _nav_btn("👤  Staff Accounts",  "navStaff")
        self.navStatistics   = _nav_btn("📊  Statistics",      "navStatistics")

        self.sidebarLayout.addStretch()

        # Version label at bottom of sidebar
        self.sidebarVersion = QtWidgets.QLabel("v1.0", parent=self.sidebar)
        self.sidebarVersion.setObjectName("sidebarVersion")
        self.sidebarVersion.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.sidebarVersion.setFixedHeight(30)
        self.sidebarLayout.addWidget(self.sidebarVersion)

        self.bodyLayout.addWidget(self.sidebar)

        # ── Right panel: stacked pages + status bar ───────────────────────
        self.rightPanel = QtWidgets.QWidget(parent=self.contentWidget)
        ...
        # Page title bar
        self.pageTitleBar = QtWidgets.QWidget(parent=self.rightPanel)
        self.pageTitleBar.setObjectName("pageTitleBar")
        self.pageTitleBar.setFixedHeight(44)
        pageTitleLayout = QtWidgets.QHBoxLayout(self.pageTitleBar)
        pageTitleLayout.setContentsMargins(20, 0, 20, 0)
        self.pageTitle = QtWidgets.QLabel(parent=self.pageTitleBar)
        self.pageTitle.setObjectName("pageTitle")
        pageTitleLayout.addWidget(self.pageTitle)
        pageTitleLayout.addStretch()
        self.rightLayout.addWidget(self.pageTitleBar)

        # Stacked widget — pages switched via sidebar nav
        self.stackedWidget = QtWidgets.QStackedWidget(parent=self.rightPanel)
        self.stackedWidget.setObjectName("stackedWidget")
        self.rightLayout.addWidget(self.stackedWidget)

        # ── Status bar ─────────────────────────────────────────────────────
        self.statusBar = QtWidgets.QWidget(parent=self.rightPanel)
        self.statusBar.setObjectName("statusBar")
        self.statusBar.setFixedHeight(28)
        statusLayout = QtWidgets.QHBoxLayout(self.statusBar)
        statusLayout.setContentsMargins(16, 0, 16, 0)
        statusLayout.setSpacing(20)

        self.lblStatusRecords = QtWidgets.QLabel("", parent=self.statusBar)
        self.lblStatusRecords.setObjectName("lblStatusRecords")
        statusLayout.addWidget(self.lblStatusRecords)

        self.lblStatusEvent = QtWidgets.QLabel("", parent=self.statusBar)
        self.lblStatusEvent.setObjectName("lblStatusEvent")
        statusLayout.addWidget(self.lblStatusEvent)

        statusLayout.addStretch()

        self.lblStatusTime = QtWidgets.QLabel("", parent=self.statusBar)
        self.lblStatusTime.setObjectName("lblStatusTime")
        statusLayout.addWidget(self.lblStatusTime)

        self.lblStatusUser = QtWidgets.QLabel("", parent=self.statusBar)
        self.lblStatusUser.setObjectName("lblStatusUser")
        statusLayout.addWidget(self.lblStatusUser)

        self.rightLayout.addWidget(self.statusBar)
        self.bodyLayout.addWidget(self.rightPanel)

        # ── Compat shim: tabWidget points to stackedWidget for legacy code ─
        self.tabWidget = self.stackedWidget
        self.contentLayout = self.rightLayout
...
"}")
        ...
        self.btnAddEvent.setStyleSheet("padding: 8px 14px; font-size: 12px; font-weight: 500;\n"
"color: white;\n"
"background-color: #1565c0; border-radius: 6px;")
        ...
        self.btnImportEvent.setStyleSheet("background-color: white; color: #1565c0; padding: 8px 14px; font-size: 12px; font-weight: 500; border-radius: 6px; border: 1.5px solid #1565c0;")
        ...
        self.btnDownloadEventTemplate.setStyleSheet("background-color: white; color: #1565c0; padding: 8px 14px; font-size: 12px; font-weight: 500; border-radius: 6px; border: 1.5px solid #1565c0;")
        ...
        self.btnViewEvent.setStyleSheet("background-color: #1976d2; color: white; padding: 7px 14px; font-size: 12px; border-radius: 6px;")
        ...
        self.btnEditEvent.setStyleSheet("background-color: #1976d2; color: white; padding: 7px 14px; font-size: 12px; border-radius: 6px;")
        ...
        self.btnDeleteEvent.setStyleSheet("background-color: #c62828; color: white; padding: 7px 14px; font-size: 12px; border-radius: 6px;")
        ...
        self.btnRefreshEvent.setStyleSheet("background-color: #546e7a; color: white; padding: 7px 14px; font-size: 12px; border-radius: 6px;")
        ...
        self.btnExportEvent.setStyleSheet("background-color: #546e7a; color: white; padding: 6px 12px; font-size: 12px; border-radius: 6px;")
        ...
        self.btnPrevEvent.setStyleSheet("background-color: #546e7a; color: white; padding: 6px 10px; font-size: 12px; border-radius: 6px;")
        ...
        self.lblPageEvent.setStyleSheet("color: #455a7a; font-size: 12px; padding: 0 8px;")
        ...
        self.btnNextEvent.setStyleSheet("background-color: #546e7a; color: white; padding: 6px 10px; font-size: 12px; border-radius: 6px;")
        ...
        self.cardTotalEvents    = make_card("cardTotalEvents",    "#0f2547", "Total Events")
        self.cardTotalAttendees = make_card("cardTotalAttendees", "#1565c0", "Total Attendees")
        self.cardTotalRegs      = make_card("cardTotalRegs",      "#1976d2", "Total Registrations")
        self.cardTotalCheckin   = make_card("cardTotalCheckin",   "#1e88e5", "Checked-in Today")
        ...
        self.btnRefreshDash.setStyleSheet("background:#546e7a;color:white;padding:7px 18px;border-radius:6px;font-size:12px;max-width:180px;")
        self.dashLayout.addWidget(self.btnRefreshDash, alignment=QtCore.Qt.AlignmentFlag.AlignRight)

        self.stackedWidget.addWidget(self.dashboardTab)   # index 0
        # ── End Dashboard Tab ──────────────────────────────────
        self.stackedWidget.addWidget(self.eventTab)         # index 1
...
"}")
        ...
        self.btnAddAttendee.setStyleSheet("background-color: #1565c0; color: white; padding: 8px 14px; font-size: 12px; font-weight: 500; border-radius: 6px;")
        ...
        self.btnImportAttendee.setStyleSheet("background-color: white; color: #1565c0; padding: 8px 14px; font-size: 12px; font-weight: 500; border-radius: 6px; border: 1.5px solid #1565c0;")
        ...
        self.btnDownloadTemplate.setStyleSheet("background-color: white; color: #1565c0; padding: 8px 14px; font-size: 12px; font-weight: 500; border-radius: 6px; border: 1.5px solid #1565c0;")
        ...
        self.btnEditAttendee.setStyleSheet("background-color: #1976d2; color: white; padding: 7px 14px; font-size: 12px; border-radius: 6px;")
        ...
        self.btnDeleteAttendee.setStyleSheet("background-color: #c62828; color: white; padding: 7px 14px; font-size: 12px; border-radius: 6px;")
        ...
        self.btnHistoryAttendee.setStyleSheet("background-color: white; color: #1565c0; padding: 7px 14px; font-size: 12px; border-radius: 6px; border: 1.5px solid #1565c0;")
        ...
        self.btnRefreshAttendee.setStyleSheet("background-color: #546e7a; color: white; padding: 7px 14px; font-size: 12px; border-radius: 6px;")
        ...
        self.btnExportAttendee.setStyleSheet("background-color: #546e7a; color: white; padding: 6px 12px; font-size: 12px; border-radius: 6px;")
        ...
        self.btnPrevAttendee.setStyleSheet("background-color: #546e7a; color: white; padding: 6px 10px; font-size: 12px; border-radius: 6px;")
        ...
        self.lblPageAttendee.setStyleSheet("color: #455a7a; font-size: 12px; padding: 0 8px;")
        ...
        self.btnNextAttendee.setStyleSheet("background-color: #546e7a; color: white; padding: 6px 10px; font-size: 12px; border-radius: 6px;")
        ...
        self.stackedWidget.addWidget(self.attendeeTab)       # index 2
        ...
        self.eventCombo.setStyleSheet("QComboBox{border: 1px solid #6f6f6f;padding: 4px 8px;color: #0f2547;background: white;border-radius: 4px;font-size: 13px;}QComboBox::drop-down{border:none;}QComboBox QAbstractItemView{background: white;color: #1e293b;selection-background-color: #1565c0;selection-color: white;border: 1px solid #dde3ec;outline: none;}")
        ...
        self.btnRegisterAttendee.setStyleSheet("padding: 8px 14px; font-size: 12px; font-weight: 500;\n"
"color: white;\n"
"background-color: #1565c0; border-radius: 6px;")
        ...
        self.btnGenerateQR.setStyleSheet("background-color: #1976d2; color: white; padding: 7px 14px; font-size: 12px; border-radius: 6px;")
        ...
        self.btnSendEmailReg.setStyleSheet("background-color: #1565c0; color: white; padding: 7px 14px; font-size: 12px; border-radius: 6px;")
        ...
        self.btnCancelRegistration.setStyleSheet("background-color: #c62828; color: white; padding: 7px 14px; font-size: 12px; border-radius: 6px;")
        ...
        self.btnRefreshRegistration.setStyleSheet("background-color: #546e7a; color: white; padding: 7px 14px; font-size: 12px; border-radius: 6px;")
        ...
        self.btnExportRegistration.setStyleSheet("background-color: #546e7a; color: white; padding: 6px 12px; font-size: 12px; border-radius: 6px;")
        ...
        self.btnPrevRegistration.setStyleSheet("background-color: #546e7a; color: white; padding: 6px 10px; font-size: 12px; border-radius: 6px;")
        ...
        self.lblPageRegistration.setStyleSheet("color: #455a7a; font-size: 12px; padding: 0 8px;")
        ...
        self.btnNextRegistration.setStyleSheet("background-color: #546e7a; color: white; padding: 6px 10px; font-size: 12px; border-radius: 6px;")
        ...
        self.stackedWidget.addWidget(self.registrationTab)   # index 3
        ...
        self.checkinEventCombo.setStyleSheet("QComboBox{border: 1px solid #6f6f6f;padding: 4px 8px;color: #0f2547;background: white;border-radius: 4px;font-size: 13px;}QComboBox::drop-down{border:none;}QComboBox QAbstractItemView{background: white;color: #1e293b;selection-background-color: #1565c0;selection-color: white;border: 1px solid #dde3ec;outline: none;}")
...
"}")
        ...
        self.totalRegisteredLabel.setStyleSheet("color: #1565c0;")
        ...
        self.totalCheckedinLabel.setStyleSheet("color: #1976d2;")
...
"}")
        ...
        self.btnCheckin.setStyleSheet("background-color: #1565c0; color: white; padding: 8px 14px; font-size: 13px; font-weight: 500; border-radius: 6px;")
        ...
        self.btnScanQR.setStyleSheet("background-color: #1976d2; color: white; padding: 8px 14px; font-size: 13px; border-radius: 6px;")
        ...
        self.btnRefreshCheckin.setStyleSheet("background-color: #546e7a; color: white; padding: 7px 14px; font-size: 12px; border-radius: 6px;")
        ...
        self.btnExportCheckin.setStyleSheet("background-color: #546e7a; color: white; padding: 6px 12px; font-size: 12px; border-radius: 6px;")
        ...
        self.stackedWidget.addWidget(self.checkinTab)        # index 4
        ...
        self.btnAddUser.setStyleSheet("padding: 8px 14px; font-size: 12px; font-weight: 500;\n"
"color: white;\n"
"background-color: #1565c0; border-radius: 6px;")
        ...
        self.btnEditUser.setStyleSheet("background-color: #1976d2; color: white; padding: 7px 14px; font-size: 12px; border-radius: 6px;")
        ...
        self.btnDeleteUser.setStyleSheet("background-color: #c62828; color: white; padding: 7px 14px; font-size: 12px; border-radius: 6px;")
        ...
        self.btnResetUserPwd.setStyleSheet("background-color: #1976d2; color: white; padding: 7px 14px; font-size: 12px; border-radius: 6px;")
        ...
        self.btnRefreshUser.setStyleSheet("background-color: #546e7a; color: white; padding: 7px 14px; font-size: 12px; border-radius: 6px;")
        ...
        self.stackedWidget.addWidget(self.userMgmtTab)       # index 5
        ...
        self.lblStatsEvent.setStyleSheet("color:#1565c0; font-weight:bold; font-size:13px;")
        ...
        self.stackedWidget.addWidget(self.statisticsTab)     # index 6
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.titleLabel.setText(_translate("MainWindow", "🎫  EVENT CHECK-IN"))
        ...
        self.sidebarTitle.setText(_translate("MainWindow", "MENU"))
        self.pageTitle.setText(_translate("MainWindow", "🏠  Dashboard"))

...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.dashUpcomingTable.setHorizontalScrollBarPolicy(QtCore.Qt.ScrollBarPolicy.ScrollBarAsNeeded)
        self.dashUpcomingTable.setSizeAdjustPolicy(QtWidgets.QAbstractScrollArea.SizeAdjustPolicy.AdjustToContents)
        ...
        self.dashUpcomingTable.horizontalHeader().setDefaultSectionSize(120)
        self.dashUpcomingTable.horizontalHeader().setStretchLastSection(True)
        ...
        self.dashRecentTable.setHorizontalScrollBarPolicy(QtCore.Qt.ScrollBarPolicy.ScrollBarAsNeeded)
        ...
        self.dashRecentTable.horizontalHeader().setDefaultSectionSize(120)
        self.dashRecentTable.horizontalHeader().setStretchLastSection(True)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.headerBar.setStyleSheet(_translate("MainWindow", "QWidget#headerBar { background: qlineargradient(x1:0,y1:0,x2:1,y2:0, stop:0 #1e293b, stop:1 #334155); }"))
        ...
        self.eventCombo.setStyleSheet(_translate("MainWindow", "QComboBox { border: 1px solid #6f6f6f; padding: 2px; color: black; }"))
        ...
        self.checkinEventCombo.setStyleSheet(_translate("MainWindow", "QComboBox { border: 1px solid #6f6f6f; padding: 2px; color: black; }"))
        ...
        self.statsEventCombo.setStyleSheet(_translate("MainWindow", "QComboBox { border: 1px solid #bdc3c7; border-radius: 4px; padding: 4px 8px; color: #1e293b; background: white; font-size: 13px; } QComboBox::drop-down { border: none; } QComboBox QAbstractItemView { background: white; color: #1e293b; selection-background-color: #3b82f6; selection-color: white; border: 1px solid #bdc3c7; }"))
        self.btnStatsBar.setStyleSheet(_translate("MainWindow", "QPushButton { background-color: #3b82f6; color: white; border: none; border-radius: 4px; padding: 7px 20px; font-size: 13px; font-weight: bold; } QPushButton:hover { background-color: #2563eb; }"))
        self.btnStatsBar.setText(_translate("MainWindow", "📊 Bar Chart"))
        self.btnStatsLine.setStyleSheet(_translate("MainWindow", "QPushButton { background-color: #e2e8f0; color: #1e293b; border: 1px solid #cbd5e1; border-radius: 4px; padding: 7px 20px; font-size: 13px; } QPushButton:hover { background-color: #3b82f6; color: white; border-color: #3b82f6; }"))
        self.btnStatsLine.setText(_translate("MainWindow", "📈 Line Chart"))
        self.btnStatsPie.setStyleSheet(_translate("MainWindow", "QPushButton { background-color: #e2e8f0; color: #1e293b; border: 1px solid #cbd5e1; border-radius: 4px; padding: 7px 20px; font-size: 13px; } QPushButton:hover { background-color: #3b82f6; color: white; border-color: #3b82f6; }"))

...
"QComboBox QAbstractItemView { background-color: white; color: black; selection-background-color: #3b82f6; selection-color: white; }")
        ...
        self.btnStatsBar.setStyleSheet("QPushButton { background-color: #1e293b; color: white; border: none; border-radius: 4px; padding: 7px 20px; font-size: 13px; font-weight: bold; } QPushButton:hover { background-color: #0f172a; };\n"
"color: black")
        ...
        self.btnStatsLine.setStyleSheet("QPushButton { background-color: #e2e8f0; color: #64748b; border: none; border-radius: 4px; padding: 7px 20px; font-size: 13px; } QPushButton:hover { background-color: #cccccc; color: #1e293b; };\n"
"color: black")
        ...
        self.btnStatsPie.setStyleSheet("QPushButton { background-color: #e2e8f0; color: #64748b; border: none; border-radius: 4px; padding: 7px 20px; font-size: 13px; } QPushButton:hover { background-color: #cccccc; color: #1e293b; };\n"
"color: black")
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.statsEventCombo.setStyleSheet(_translate("MainWindow", "QComboBox { border: 1px solid #bdc3c7; border-radius: 4px; padding: 4px 8px; color: #1e293b; background: white; font-size: 13px; } QComboBox::drop-down { border: none; }"))
